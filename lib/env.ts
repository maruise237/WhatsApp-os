...
const schema = z.object({
  ...
  WHATSAPP_GATEWAY_TOKEN: required("WHATSAPP_GATEWAY_TOKEN"),

  // SeaweedFS S3-compatible, bucket privé des médias Sales OS.
  SEAWEEDFS_S3_ENDPOINT: z.string().optional().default(""),
  SEAWEEDFS_S3_REGION: z.string().default("us-east-1"),
  SEAWEEDFS_S3_ACCESS_KEY: z.string().optional().default(""),
  SEAWEEDFS_S3_SECRET_KEY: z.string().optional().default(""),
  SEAWEEDFS_MEDIA_BUCKET: z.string().default("media-bucket"),

  // WAHA historique, conservé pendant la migration progressive vers Evolution Go.

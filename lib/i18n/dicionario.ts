...
export const DICIONARIO: Traducoes = {
  ...
  "Revise os campos da automação.": { "fr-FR": "Vérifiez les champs de l’automatisation." },
  "Automação atualizada.": { "fr-FR": "Automatisation mise à jour." },
  "Automação criada — ligue quando estiver pronta.": {
    "fr-FR": "Automatisation créée — activez-la lorsqu’elle est prête.",
  },
  "Editar automação": { "fr-FR": "Modifier l’automatisation" },
  "Nova automação": { "fr-FR": "Nouvelle automatisation" },
  "Monte a regra em três passos: quando algo acontece, opcionalmente confira uma condição, e então dispare uma ou mais ações.":
    {
      "fr-FR":
        "Construisez la règle en trois étapes : lorsqu’un événement survient, vérifiez éventuellement une condition, puis déclenchez une ou plusieurs actions.",
    },
  "Nome da automação": { "fr-FR": "Nom de l’automatisation" },
  "Boas-vindas a contato novo": { "fr-FR": "Bienvenue à un nouveau contact" },
  QUANDO: { "fr-FR": "QUAND" },
  "Escolha o gatilho": { "fr-FR": "Choisissez le déclencheur" },
  "SE (opcional)": { "fr-FR": "SI (facultatif)" },
  "usar campo da lista": { "fr-FR": "utiliser un champ de la liste" },
  "usar campo avançado": { "fr-FR": "utiliser un champ avancé" },
  "Adicionar condição": { "fr-FR": "Ajouter une condition" },
  ENTÃO: { "fr-FR": "ALORS" },
  "Mover ação para cima": { "fr-FR": "Déplacer l’action vers le haut" },
  "Mover ação para baixo": { "fr-FR": "Déplacer l’action vers le bas" },
  "Remover ação": { "fr-FR": "Supprimer l’action" },
  "Adicionar ação": { "fr-FR": "Ajouter une action" },
  "A automação nasce pausada. Revise e ligue quando estiver pronta.": {
    "fr-FR":
      "L’automatisation est créée en pause. Vérifiez-la et activez-la lorsqu’elle est prête.",
  },
  "Salvar alterações": { "fr-FR": "Enregistrer les modifications" },
  "Criar automação": { "fr-FR": "Créer l’automatisation" },
  "Automação ligada.": { "fr-FR": "Automatisation activée." },
  "Automação pausada.": { "fr-FR": "Automatisation mise en pause." },
  "Crie sua primeira automação": { "fr-FR": "Créez votre première automatisation" },
  "Ex.: quando entrar um contato novo, enviar uma mensagem de boas-vindas.": {
    "fr-FR": "Ex. : lorsqu’un nouveau contact arrive, envoyer un message de bienvenue.",
  },
  ação: { "fr-FR": "action" },
  "Excluir automação": { "fr-FR": "Supprimer l’automatisation" },
  "Excluir esta automação?": { "fr-FR": "Supprimer cette automatisation ?" },
  "para de rodar imediatamente. Essa ação não pode ser desfeita.": {
    "fr-FR": "cessera immédiatement de fonctionner. Cette action est irréversible.",
  },
  "Automação excluída.": { "fr-FR": "Automatisation supprimée." },
  "Salvando…": { "fr-FR": "Enregistrement…" },
  ...
  Valor: { "fr-FR": "Valeur" },
  "Ex.: 3": { "fr-FR": "Ex. : 3" },
  draft: { "fr-FR": "Brouillon" },
  published: { "fr-FR": "Publié" },
  superseded: { "fr-FR": "Remplacé" },
  archived: { "fr-FR": "Archivé" },
  "Sem mudanças.": { "fr-FR": "Aucune modification." },
  Tools: { "fr-FR": "Outils" },
  Adicionadas: { "fr-FR": "Ajoutées" },
  Removidas: { "fr-FR": "Supprimées" },
  "Handoff keywords": { "fr-FR": "Mots-clés de relais humain" },
  "Follow-up": { "fr-FR": "Follow-up" },
  Habilitado: { "fr-FR": "Activé" },
  "Fluxos adicionados": { "fr-FR": "Flows ajoutés" },
  "Fluxos removidos": { "fr-FR": "Flows supprimés" },
  "Nenhuma versão criada ainda.": { "fr-FR": "Aucune version créée pour le moment." },
  "Não há outra versão para comparar.": { "fr-FR": "Aucune autre version à comparer." },
  "Revertido para versão equivalente a v": { "fr-FR": "Rétabli vers une version équivalente à v" },
  "publicada como v": { "fr-FR": "publiée comme v" },
  "publicada em": { "fr-FR": "publiée le" },
  Diff: { "fr-FR": "Différence" },
  Reverter: { "fr-FR": "Rétablir" },
  "Reverter para v": { "fr-FR": "Rétablir vers v" },
  "Uma nova versão idêntica a v": { "fr-FR": "Une nouvelle version identique à v" },
  "será criada e publicada imediatamente. A versão atualmente publicada vira superseded.": {
    "fr-FR":
      "sera créée et publiée immédiatement. La version actuellement publiée deviendra remplacée.",
  },
  "Revertendo…": { "fr-FR": "Rétablissement…" },
  "Confirmar revert": { "fr-FR": "Confirmer le rétablissement" },
  Teste: { "fr-FR": "Test" },
  ...
  Execução: { "fr-FR": "Exécution" },
  Iniciado: { "fr-FR": "Démarrée" },
  "Ver conversa": { "fr-FR": "Voir la conversation" },
  "Ver inbound": { "fr-FR": "Voir le message entrant" },
  Trace: { "fr-FR": "Trace" },
  "Selecione uma execução.": { "fr-FR": "Sélectionnez une exécution." },
  "execuções recentes": { "fr-FR": "exécutions récentes" },
  "Atualizando…": { "fr-FR": "Actualisation…" },
  Atualizar: { "fr-FR": "Actualiser" },
  "Erro ao carregar execuções.": { "fr-FR": "Erreur lors du chargement des exécutions." },
  "Tokens (in/out)": { "fr-FR": "Tokens (entrée/sortie)" },
  Steps: { "fr-FR": "Étapes" },
  "Nenhuma execução ainda.": { "fr-FR": "Aucune exécution pour le moment." },
  teste: { "fr-FR": "test" },
  produção: { "fr-FR": "production" },
  Detalhes: { "fr-FR": "Détails" },
  pending: { "fr-FR": "en attente" },
  running: { "fr-FR": "en cours" },
  completed: { "fr-FR": "terminée" },
  failed: { "fr-FR": "échouée" },
  aborted: { "fr-FR": "abandonnée" },
  timeout: { "fr-FR": "délai dépassé" },
  "falhando sempre": { "fr-FR": "échoue systématiquement" },
  falhas: { "fr-FR": "échecs" },
  "usada sem estar ligada": { "fr-FR": "utilisée sans être activée" },
  "nunca usada": { "fr-FR": "jamais utilisée" },
  "ligada agora": { "fr-FR": "activée récemment" },
  "só em teste": { "fr-FR": "uniquement en test" },
  funcionando: { "fr-FR": "fonctionnelle" },
  "que você está editando": { "fr-FR": "que vous modifiez" },
  "que está no ar": { "fr-FR": "actuellement en ligne" },
  antiga: { "fr-FR": "ancienne" },
  nunca: { "fr-FR": "jamais" },
  uso: { "fr-FR": "utilisation" },
  usos: { "fr-FR": "utilisations" },
  "nos últimos": { "fr-FR": "au cours des" },
  dias: { "fr-FR": "derniers jours" },
  falha: { "fr-FR": "échec" },
  "Nada pedindo decisão no momento.": { "fr-FR": "Aucune décision requise pour le moment." },
  "capacidade pede uma decisão sua": { "fr-FR": "capacité nécessite une décision de votre part" },
  "capacidades pedem uma decisão sua": {
    "fr-FR": "capacités nécessitent une décision de votre part",
  },
  "O que está ligado vem da versão": {
    "fr-FR": "Les capacités activées proviennent de la version",
  },
  desligada: { "fr-FR": "désactivée" },
  "em teste": { "fr-FR": "en test" },
  "última vez": { "fr-FR": "dernière utilisation" },
  "Este agente ainda não tem nenhuma capacidade ligada, e nenhuma foi usada. Ligue o que ele pode fazer na aba Configuração.":
    {
      "fr-FR":
        "Cet agent n’a encore aucune capacité activée et n’en a utilisé aucune. Activez ce qu’il peut faire dans l’onglet Configuration.",
    },
  ...
  erro: { "fr-FR": "erreur" },
  Args: { "fr-FR": "Arguments" },
  Result: { "fr-FR": "Résultat" },
  Error: { "fr-FR": "Erreur" },
  truncado: { "fr-FR": "tronqué" },
  "Mensagem que SERIA enviada": { "fr-FR": "Message qui SERAIT envoyé" },
  ...
  "Publique um fluxo de follow-up": { "fr-FR": "Publiez un flow de follow-up" },
  "para vinculá-lo.": { "fr-FR": "pour le rattacher." },
  "Fluxos publicados": { "fr-FR": "Flows publiés" },
  "Máximo de 20 fluxos por agent.": { "fr-FR": "Maximum de 20 flows par agent." },
  "Chave de acesso": { "fr-FR": "Clé d’accès" },
  "Escolha uma chave": { "fr-FR": "Choisissez une clé" },
  "A chave desta instalação (": { "fr-FR": "Clé de cette installation (" },
  validada: { "fr-FR": "validée" },
  validando: { "fr-FR": "validation en cours" },
  inválida: { "fr-FR": "invalide" },
  inativa: { "fr-FR": "inactive" },
  "Nenhuma credencial": { "fr-FR": "Aucun credential" },
  cadastrada: { "fr-FR": "enregistré" },
  "Cadastrar credencial": { "fr-FR": "Enregistrer un credential" },
  "na aba Credenciais.": { "fr-FR": "dans l’onglet Credentials." },
  "Selecione um modelo": { "fr-FR": "Sélectionnez un modèle" },
  "Nenhum modelo disponível": { "fr-FR": "Aucun modèle disponible" },
  " · default": { "fr-FR": " · par défaut" },
  ...
  "Freios de segurança": { "fr-FR": "Garde-fous de sécurité" },
  "Ações por atendimento (1 a 25)": { "fr-FR": "Actions par conversation (de 1 à 25)" },
  "Volume de texto por atendimento": { "fr-FR": "Volume de texte par conversation" },
  "Custo máximo por atendimento (centavos)": {
    "fr-FR": "Coût maximal par conversation (centimes)",
  },
  ...
  "Nome do lead": { "fr-FR": "Nom du lead" },
  "Tags do lead": { "fr-FR": "Étiquettes du lead" },
  "Origem (utm_source)": { "fr-FR": "Origine (utm_source)" },
  "Etapa de destino": { "fr-FR": "Étape de destination" },
  "Tags do contato": { "fr-FR": "Étiquettes du contact" },
  "Tag adicionada": { "fr-FR": "Étiquette ajoutée" },
  "Quando entrar um contato novo (webhook)": {
    "fr-FR": "Lorsqu’un nouveau contact arrive (webhook)",
  },
  "Quando um lead mudar de etapa": { "fr-FR": "Lorsqu’un lead change d’étape" },
  "Quando chegar mensagem no WhatsApp": {
    "fr-FR": "Lorsqu’un message arrive sur WhatsApp",
  },
  "Quando um lead ganhar uma tag": { "fr-FR": "Lorsqu’un lead reçoit une étiquette" },
  "Quando um contato ganhar uma tag": {
    "fr-FR": "Lorsqu’un contact reçoit une étiquette",
  },
  "Criar/mover lead no funil": { "fr-FR": "Créer/déplacer un lead dans l’entonnoir" },
  "Enviar mensagem no WhatsApp": { "fr-FR": "Envoyer un message sur WhatsApp" },
  "Atribuir a um atendente": { "fr-FR": "Attribuer à un agent" },
  "Avisar outro sistema (webhook)": {
    "fr-FR": "Notifier un autre système (webhook)",
  },
  ...
  "Seguir por aqui quando": { "fr-FR": "Suivre par ici lorsque" },
  "em": { "fr-FR": "dans" },
  "ex: vip, carrinho-abandonado": { "fr-FR": "ex. : vip, panier-abandonné" },

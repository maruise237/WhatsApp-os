...
export const AUDIT_ACTIONS = [
  ...
  // AI WhatsApp Sales OS — catalogue, commandes et décision humaine de paiement.
  "sales.product_created",
  "sales.product_updated",
  "sales.product_archived",
  "sales.order_created",
  "sales.order_status_changed",
  "sales.payment_proof_submitted",
  "sales.payment_approved",
  "sales.payment_rejected",
] as const;

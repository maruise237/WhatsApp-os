...
export const ApiErrorCodes = {
  ...
  payment_not_confirmed: "payment_not_confirmed", // novo dono não é membro ativo agent+ da org (bulk assign, G3-04)
  ...
  unavailable: "unavailable", // 503: dependência de config ausente (ex.: pool do engine sem NEON_DATABASE_URL)

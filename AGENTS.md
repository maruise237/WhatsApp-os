...
WhatsApp como canal primário. A base histórica usa WAHA ; a cible AI WhatsApp Sales OS migre vers Evolution Go derrière `whatsapp-gateway`, conformément à `01-ai-whatsapp-sales-os-constitution.md`. Multi-tenant com RLS desde o dia 1, LGPD nativa. Monetização = self-host em VPS, não assinatura. Posicionamento: [`VISION.md`](VISION.md).

**Documents normatifs du Sales OS** : [`01-ai-whatsapp-sales-os-constitution.md`](01-ai-whatsapp-sales-os-constitution.md), [`02-ai-whatsapp-sales-os-spec.md`](02-ai-whatsapp-sales-os-spec.md), [`03-ai-whatsapp-sales-os-plan.md`](03-ai-whatsapp-sales-os-plan.md), [`04-ai-whatsapp-sales-os-tasks.md`](04-ai-whatsapp-sales-os-tasks.md). Une tâche de code doit être référencée dans le fichier `04` avant son implémentation.
...
Vercel AI Gateway (`@ai-sdk/anthropic|openai|google`) · WAHA Plus (adaptateur historique) · Evolution Go via `whatsapp-gateway` (cible Sales OS) ·

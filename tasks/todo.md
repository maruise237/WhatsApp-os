...
### Épico AI WhatsApp Sales OS — adaptation guidée par constitution

- [x] Constitution, spécification, plan et tâches ajoutés à la racine (`01`–`04-ai-whatsapp-sales-os-*`)
- [x] Matrice de traçabilité ajoutée (`docs/ai-whatsapp-sales-os-traceability.md`)
- [~] Remplacement progressif de WAHA par Evolution Go via `whatsapp-gateway`
- [ ] Catalogue, commandes, preuves de paiement et Central vendeur
- [ ] Validation mobile/PWA et parcours de reprise le lendemain

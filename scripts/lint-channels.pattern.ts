 ...
 * `waha_session_name`, `lib/waha/client`, `meta_cloud`, `evolution_go`, `graph.facebook.com`.
 *
 ...
 * mesmo commit.
 */
const SEPARADO = /(?<![a-zA-Z0-9])(waha|meta_cloud|zernio|evolution_go|graph\.facebook\.com)(?![a-zA-Z0-9])/i;
 ...
 */
const PASCAL = /(Waha|Zernio|EvolutionGo)(?![a-z0-9])/;

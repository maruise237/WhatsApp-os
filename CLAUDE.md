...
- `01-ai-whatsapp-sales-os-constitution.md` — constitution non négociable du MVP AI WhatsApp Sales OS.
- `02-ai-whatsapp-sales-os-spec.md` — exigences fonctionnelles testables du MVP.
- `03-ai-whatsapp-sales-os-plan.md` — architecture cible et stratégie d’adaptation de DeskcommCRM.
- `04-ai-whatsapp-sales-os-tasks.md` — tâches atomiques autorisées, à suivre dans l’ordre.

...
# A posição da cor DENTRO da fila acima — o provider é a 1ª resposta, depois vêm
# APP_IMAGE, APP_NAME e ela é a 4ª: a chave Anthropic já existe no BASE_ENV, então
# não há pergunta para ela. Fica numa variável porque a fila com a cor RESPONDIDA
